...
//     setIsLoading(true);
//     try{
//       const response = await axios.post("http://localhost:5000/api/mail/save-emailbody",
//         {
...
//     try {
//       await axios.delete(`http://localhost:5000/api/mail/delete-emailbody/${id}`, {
//         headers: {
//           'Authorization': 'Bearer ' + localStorage.getItem('token')
//         }
//       });
...
//     } catch (e) {
//       toast.error("Failed to delete email body");
//     }
//   };
...
//                 <h3>{emailBodies.subject}</h3>
//                 <p>{emailBodies.html}...</p>
//                 <div className="email-body-actions">
//                   <button className="btn edit-btn">Edit</button>
//                   <button
//                     className="btn delete-btn"
//                     onClick={() => deleteEmailBody(emailBodies._id)}
//                   >
//                     Delete
//                   </button>
//                 </div>
